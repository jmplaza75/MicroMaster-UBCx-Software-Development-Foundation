...
public class LiveTwitterSource extends TwitterSource {
    ...
    private void initializeTwitterStream() {
        ...
        cb.setOAuthConsumerKey("nMSrxYtcz5HuG370MACs0yJTA")
                .setOAuthConsumerSecret("Lg1gpv0ZiaKQqYHCLx3bHyVpld7zMbeQprdmzMfgCJR73u0TvL")
                .setOAuthAccessToken("310330807-D4GOqcYkuJXH1ysMhUe6rXLlCKQgCYaXa0boQXvX")
                .setOAuthAccessTokenSecret("rTqwDH7vbnQKVQJ8IeiFbEaOzdWp7Ap7yp1NrWcMuzXEX");
