...
//        twitterSource = new PlaybackTwitterSource(60.0);
    ...
    /**
     * Returns a set of all terms mentioned in all queries. The live Twitter source uses this
     * to request matching tweets from the Twitter API.
     *
     * @return a set of strings representing all filter terms across all active queries
     */
